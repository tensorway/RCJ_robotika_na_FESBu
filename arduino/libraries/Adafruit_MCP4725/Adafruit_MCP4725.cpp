...
void Adafruit_MCP4725::setVoltage( uint16_t output, bool writeEEPROM )
{
  ...
  if (writeEEPROM)
  {
    Wire2.write(MCP4726_CMD_WRITEDACEEPROM);
  }
  else
  {
    Wire.write(MCP4726_CMD_WRITEDAC);
  }
  Wire2.write(output / 16);                   // Upper data bits          (D11.D10.D9.D8.D7.D6.D5.D4)
  Wire2.write((output % 16) << 4);            // Lower data bits          (D3.D2.D1.D0.x.x.x.x)
